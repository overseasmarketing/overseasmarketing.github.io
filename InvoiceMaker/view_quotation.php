...
<body class="container-fluid p-0">
    ...
    $QuotationIssueDate = $row["QuotationDate"];
    $QuotationIssueDate = date("d-m-Y", strtotime($QuotationIssueDate));
