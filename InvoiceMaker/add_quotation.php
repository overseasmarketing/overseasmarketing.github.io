...
<body>
    <div class="container">
        <h2 class="mt-5">Add New Quotation</h2>
        <form action="add_quotation.php" method="post" class="mt-4">
            <div class="row">
                <div class="col-sm-12 col-md-4 col-lg-6">
                    <div class="mb-3">
                        <label for="QuotationDate" class="form-label">Quotation Date</label>
                        <input type="date" class="form-control" id="QuotationDate" name="QuotationDate" required>
                    </div>
                </div>
                <div class="col-sm-12 col-md-4 col-lg-6">
                    <div class="mb-3">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "INSERT INTO quotations (QuotationDate, ClientID, Product1_Description, Product1_Quantity, Product1_Rate, Product1_Total,
            ...
            Product6_Description, Product6_Quantity, Product6_Rate, Product6_Total, ApprovalStatus, QuotationAuthor) VALUES ('$QuotationDate', '$clientID', '$product1_description', '$product1_quantity', '$product1_rate', '$product1_total',
            '$product2_description', '$product2_quantity', '$product2_rate', '$product2_total',
            '$product3_description', '$product3_quantity', '$product3_rate', '$product3_total',
            '$product4_description', '$product4_quantity', '$product4_rate', '$product4_total',
            '$product5_description', '$product5_quantity', '$product5_rate', '$product5_total',
            '$product6_description', '$product6_quantity', '$product6_rate', '$product6_total', '$approvalStatus', '$QuotationAuthor')";
