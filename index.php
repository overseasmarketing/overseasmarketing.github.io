...
<body class="bg-black text-white" data-bs-spy="scroll" data-bs-target="#navScroll">
    ...
    <main>
        ...
        <div class="container p-5 animate__animated animate__fadeIn">
            ...
            <p>
                We are a dynamic and innovative marketing firm that specializes in helping businesses
            ...
            <p>
                We charge according to the level of service you require.
            </p> -->
        </div>
                ...
                <div class="col-sm-12 col-md-12 col-lg-3 mt-3">
                    <div onclick="services()" class="p-3 our-work-card text-white">
                        ...
                        <p class="mt-2">
                            ...
                            through
                            various media channels to
                            attract and influence potential customers.
                        </p>
                    </div>
                </div>
                <div class="col-sm-12 col-md-12 col-lg-3 mt-3">
                    <div onclick="services()" class="p-3 our-work-card text-white">
                        ...
                        <p class="mt-2">
                            ...
                            interfaces
                            (UI) for optimal user
                            interaction and satisfaction (UX).
                        </p>
                    </div>
                </div>
                <div class="col-sm-12 col-md-12 col-lg-3 mt-3">
