...
<head>
  ...
  <script type="text/javascript">
    ...
    })(window, document, "clarity", "script", "hwbtpvhu46");
  </script>
  <!-- Google tag (gtag.js) -->
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-K65WHLZ80K"></script>
  <script>
      ...
      <div class="container py-vh-4 position-relative mt-5 px-vw-5 text-center">
        <div class="row d-flex align-items-center justify-content-center py-vh-5">
          <div class="col-12 col-xl-10">
            ...
            <script>
              let audience = ['business owners', 'influencers', 'startups', 'small businesses', 'creators', 'artists', 'freelancers', 'designers', 'entrepreneurs', 'EVERYONE']
              let i = 0;
      ...
      <div class="container px-vw-5 py-vh-5">
        <div class="row d-flex align-items-center">
          <div class="col-12 col-lg-7 text-lg-end">
            ...
            <h2 class="display-4">
              we offer a wide range of <span class="text-danger">marketing services</span>, including market research,
            ...
            <div class="card bg-transparent mb-5 mt-5" data-aos="zoom-in-up">
              <div class="bg-dark shadow rounded-5 p-0">
                ...
                <div class="p-5">
                  ...
                  <p class="pb-4 text-secondary">
                    SEO, or Search Engine Optimization, is the process of improving the visibility and ranking of a
            ...
            <div class="card bg-transparent" data-aos="zoom-in-up">
              <div class="bg-dark shadow rounded-5 p-0">
                ...
                <div class="p-5">
                  ...
                  <p class="pb-4 text-secondary">
                    Elevate your brand's presence with our expert brand designing. Craft captivating visual identities
                    that resonate with your audience and make a lasting impression. Stand out in the digital landscape.
                  </p>
                  <!-- <a href="#" class="link-fancy link-fancy-light">Read more</a> -->
                </div>
              </div>
    ...
    <div class="container-fluid px-vw-5 position-relative" data-aos="fade">
      ...
      <div class="position-relative py-vh-5 bg-cover bg-center rounded-5"
        ...
        <div class="container bg-black px-vw-5 py-vh-3 ro unded-5 shadow">
          <div class="row d-flex align-items-center">
            <div class="col-12 d-flex align-items-center bg-dark shadow rounded-5 p-0" data-aos="zoom-in-up">
                ...
                <div class="col-12 col-sm-12 col-md-8 col-lg-8 my-1">
                  <p class="lead p-5 border-secondary">
                    <span class="text-secondary fs-6">
                      ...
                      awareness, we have the expertise and resources to help you achieve your goals. With a team of
                      experienced professionals, we offer a wide range of digital marketing services. Trust us to help
                      you
                      navigate the complexities of the global marketplace and drive your brand to new heights of
                      success.
                      <br>
                      Warm Regards,<br>
                      <span class="text-white">Overseas Marketing</span>
                      <script>
                        let customerLetter = ['business owners', 'influencers', 'startups', 'small businesses', 'creators', 'artists', 'freelancers', 'designers', 'entrepreneurs', 'everyone']
                        let j = 0;
        ...
        <div class="row d-flex gx-5 align-items-center">
          <div class="col-12 col-lg-6">
            <div class="rounded-5 bg-black p-5 shadow" data-aos="zoom-in-right">
              ...
              <p class="lead text-secondary fs-6">
                Our experience working with Overseas Digital Marketing Agency on our website development needs was
                fantastic. They recognized the needs of our target market and our business goals, which produced a
                beautiful and easy-to-use website. The attention to detail, responsive design makes them the perfect
              ...
              <div class="d-flex justify-content-start align-items-center border-top border-secondary pt-3">
                <img src="img/clients/code.png" width="96" height="96" class="rounded-circle me-3" alt="a nice person"
                  data-aos="fade">
                <div>
            ...
            <div class="rounded-5 bg-black p-5 shadow mt-5" data-aos="zoom-in-right">
              ...
              <p class="lead text-secondary fs-6">
                Working with Overseas Digital Marketing Agency for our social media management needs was a game-changer.
                Their expertise and strategic approach increased our brand engagement and follower growth significantly.
                Their up-to-date knowledge and open communication made them an invaluable partner. Highly recommended
          ...
          <div class="col-12 col-lg-6">
            ...
            <div class="rounded-5 bg-black p-5 shadow mt-5" data-aos="zoom-in-left">
              ...
              <p class="lead text-secondary fs-6">
                Working with Overseas Digital Marketing Agency for our SEO needs was a game-changer. Their expertise and
                strategic approach improved our search engine rankings and boosted organic traffic. Their commitment to
                staying ahead of industry trends and transparent communication made them an invaluable partner. Highly
              ...
              <div class="d-flex justify-content-start align-items-center border-top pt-3">
                <img src="img/clients/mb.png" width="96" height="96" class="rounded-circle me-3" alt="a nice person"
                  data-aos="fade">
                <div>
