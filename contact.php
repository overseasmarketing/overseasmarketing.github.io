                        ...
                        <div class="row">
                            ...
                            <div class="mt-3">
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 col-lg-3 mt-1">
                                        ...
                                        <select style="background-color: black !important;"
                                            class="form-control form-input" name="country_code" id="country_code">
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-9 mt-1">
                            ...
                            <div class="col-12 mt-3">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control form-input" name="message" id="message" cols="30"
                            ...
                            <div class="col-12 mt-3">
                                <div class="form-group">
                                    <input type="hidden" value="<?php echo date('d-m-Y'); ?>"
                                        class="form-control form-input" name="date" id="date" required>
                                </div>
                            </div>
