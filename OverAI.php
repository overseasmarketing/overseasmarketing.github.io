            ...
            <div class="container px-vw-5 py-vh-5">
                <div class="row d-flex align-items-center">
                    <div class="col-12 col-lg-7 text-lg-end">
                        <span class="h5 text-secondary fw-lighter">Over AI</span>
                        <div class="card p-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="alert">
                                    <input id="prompt" name="prompt" type="text" placeholder="Enter your prompt">
                                    <button onclick="generateContent();" class="btn btn-dark">Send</button>
                                </div>
